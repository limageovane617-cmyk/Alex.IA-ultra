...
class GaussianDiffusion:
    ...
    def q_mean_variance(self, x_start, t):
        ...
        mean = _extract_into_tensor(self.one_minus_sigmas, t, x_start.shape) * x_start
    ...
    def training_losses(self, model, x_start, timestep, guide_image, flow_score, model_kwargs=None, noise=None, skip_noise=False):
        """
        ...
        x_t[:,:,:1,:,:] = torch.lerp(x_t[:,:,:1,:,:], guide_image, 1.0)
        #print("guide_image.shape",x_t.shape)
        ...
        if self.loss_type == LossType.KL or self.loss_type == LossType.RESCALED_KL:
            ...
            #print("t",t)
            model_output = model(x_t, t, guide_image,  cond_mask, flow_score, **model_kwargs)
