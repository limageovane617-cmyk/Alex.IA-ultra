...
class _WrappedModel:
    ...
    def __call__(self, x, timestep, guide_image, cond_mask, flow_score, **kwargs):
        ...
        return self.model(x, timestep=new_ts, guide_image=guide_image, cond_mask=cond_mask, flow_score=flow_score, **kwargs)