...
st.write("Teste do gerador de imagens do Alex IA Ultra.")

prompt = st.text_area(
    "📝 Descrição da imagem",
    "Uma cidade futurista à noite, ruas molhadas refletindo luzes neon, aparência cinematográfica e realista."
)
